...
export default function ReceiptForm({ data, onChange }) {
  ...
  const councilMembers = [
    { name: "Annisa D. Arsa", position: "Chief Minister" },
    { name: "Nor-Ainie T. Macalatas", position: "Exec. Sec" },
    { name: "Mohammad Hosni M. Pallantig", position: "Minister of Public Affairs" },
    { name: "Amar O. Sultan", position: "Minister of Finance" },
    { name: "Sittie Aisha C. Abdulmanan", position: "Minister of Audit" },
    { name: "Hafsah R. Mangorangca", position: "Minister of Academic Affairs" },
    { name: "Sarhaji G. Mundig", position: "Minister of Press & Information" },
    { name: "Honey Jane B. Mamac", position: "Minister of Documentation" },
    { name: "Mohammad M. Camid", position: "Minister of Business Operation" },
    { name: "Norhadi M. Norodin", position: "CSRAW" },
    { name: "Al-Dajik M. Agakhan", position: "SSG Representative" },
    { name: "John Warren A. Villarta", position: "SSG Representative" },
    { name: "Pee Jay C. Patos", position: "DCS Representative" },
    { name: "Saibah H.O. Saidamen", position: "DIS Representative" },
    { name: "Jellan Fatmah P. Radiamoda", position: "Minister of Sports and Recreation" }
  ];
